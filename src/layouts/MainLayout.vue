...
<template>
  <q-layout view="lHh Lpr lFf">
    <q-header>
      ...
      <q-img
      img src="~\public\images\palmtree.jpg"
    ...
    <q-drawer v-model="leftDrawerOpen" show-if-above :width="250" :breakpoint="600">
        ...
        <q-img class="absolute-top" src="~\public\images\palmtree.jpg" style="height: 192px">
          <div class="absolute-bottom bg-transparent">
            <q-avatar size="56px" class="q-mb-sm">
              <img src="~\public\images\Avatar.jpg">
            </q-avatar>
            <div class="text-weight-bold">Kelli Smith</div>
          </div>
        </q-img>
      </q-drawer>
    <q-page-container>
